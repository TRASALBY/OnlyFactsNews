...
public class Headnews4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        headNews4 = rootView.findViewById(R.id.box_mainNews4);
        title = rootView.findViewById(R.id.title_head4);
        time = rootView.findViewById(R.id.time_head4);
        img = rootView.findViewById(R.id.img_head4);
        field = rootView.findViewById(R.id.field_head4);
